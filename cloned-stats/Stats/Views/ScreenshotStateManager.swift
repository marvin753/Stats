...
//  Purpose: Manages accumulation of multiple screenshots captured via Cmd+Shift+K
//  before batch processing with Cmd+Shift+P
//
...
extension ScreenshotStateManager {
    enum ScreenshotError: LocalizedError {
        ...
        var errorDescription: String? {
            switch self {
            case .noScreenshotsAvailable:
                return "No screenshots available for processing. Please capture at least one screenshot using Cmd+Shift+K."
